...
| plumbing | 4 | **599** | 1470 | 817 |
| island | 2 | **199** | 590 | 350 |
| **total** | **10** | **1139** | **3427** | **2120** |

Physical LOC overstates code by **2120** non-code lines
...
| `src/ui/app-shell.ts` | plumbing | 328 | 7603 | 39 | 3 | 14 | 22 | 4 | _unmatched_ |
...
| `src/ui/splitters.ts` | island | 42 | 986 | 2 | 4 | 0 | 0 | 0 | _unmatched_ |
| `src/ui/workbench/workbench-shell.ts` | plumbing | 164 | 5772 | 17 | 4 | 2 | 6 | 0 | _unmatched_ |

> 8 manifest file(s) absent in this state — measured against the one canonical
> manifest so every state covers an identical file set (a deletion must show up, not vanish).

> 10 file(s) had no lcov record — reported as unmatched, never as zero branches.

## Environment

- **commit**: `d319847875b3b3eeff2c4ca4c43fd7dda12f8b40`
- **commitDirty**: `clean`
- **node**: `v25.9.0`
- **esbuild**: `0.28.1`
