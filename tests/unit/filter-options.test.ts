...
import type { ReadFilterOptionsInput } from '../../src/core/filter-options.js';
import type { Column } from '../../src/core/panel-cfg.js';

const read = (columns: Column[], row: unknown, extra: Partial<ReadFilterOptionsInput> = {}) =>
  readFilterOptions({ columns, row, rowCount: 1, ...extra });
