 ...
 */
export function splitStatements(sql?: string | null): string[] {
 ...
 *  Pure. */
export function leadingKeyword(stmt?: string | null): string {
  const s = String(stmt || '');
...
export function isRowReturning(stmt?: string | null): boolean {
 ...
 */
export function isAutoRunnable(sql?: string | null): boolean {
