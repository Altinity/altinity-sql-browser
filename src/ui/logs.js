...
// surface for log-shaped fallback results. Deliberately inert next to
// renderGrid — no sorting, no column resize; rows render in query order.
// Row shaping / level classification is pure in core/logs.js; this is the
// thin DOM wrapper.

import { h } from './dom.js';
import { truncationFooter } from './results.js';
