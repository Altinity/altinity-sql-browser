...
export const grafanaGridLayoutV2Schema = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://altinity.com/schemas/altinity-sql-browser/dashboard-layout-grafana-grid-v2.schema.json",
  "title": "Altinity SQL Browser Dashboard grafana-grid@2 layout",
  "description": "The normative authored Dashboard layout. Grid, Full, and Report are persisted base styles with independent per-tile dimensions. Grid defaults to 6 columns by 2 height units, Full to fixed width 12 by height 2, and Report to centered fixed width 9/12 by height 5. A flow@1 fallback is carried by the Dashboard layout envelope and regenerated from the selected base style.",
  "x-altinity-kind": "dashboard-layout-grafana-grid",
  "x-altinity-version": 2,
  "type": "object",
  "required": [
  ...
  "properties": {
    ...
    "preset": {
      "title": "Authored base style",
      "description": "The persisted base style. Two- and three-column choices are session previews and are never stored here.",
      "type": "string",
      "enum": [
        "grid",
        "full",
    ...
    "items": {
      "title": "Per-tile style dimensions",
      "description": "Independent Grid, Full, and Report dimensions keyed by tile ID. Missing style entries use that style's designed defaults.",
      "type": "object",
      "maxProperties": 100,
      "propertyNames": {
        "minLength": 1,
      ...
      "additionalProperties": {
        "$ref": "#/$defs/grafanaGridTileStylesV2"
      }
    }
  },
  "additionalProperties": false,
  ...
  "$defs": {
    "grafanaGridHeightV2": {
      "title": "Tile height",
      "description": "Numeric row units from 1 through 16; pixels = 32 + 88 × units.",
      "type": "integer",
      "minimum": 1,
      "maximum": 16
    },
    "grafanaGridTilePlacementV2": {
    ...
    "grafanaGridFixedPlacementV2": {
      "title": "Fixed-width style dimensions",
      "type": "object",
      "properties": {
        "height": {
          "$ref": "#/$defs/grafanaGridHeightV2"
    ...
    "grafanaGridTileStylesV2": {
      "title": "Independent tile dimensions by authored style",
      "type": "object",
      "properties": {
        "grid": {
          "$ref": "#/$defs/grafanaGridTilePlacementV2"
        },
        "full": {
          "$ref": "#/$defs/grafanaGridFixedPlacementV2"
        },
        "report": {
          "$ref": "#/$defs/grafanaGridFixedPlacementV2"
        }
...
export const storedWorkspaceV3Schema = {
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://altinity.com/schemas/altinity-sql-browser/stored-workspace-v3.schema.json",
  "title": "Altinity SQL Browser stored workspace v3",
  ...
  "properties": {
    "storageVersion": {
      "title": "Storage version",
      "description": "Stored-workspace contract version; always 3 for this contract. Unknown future versions fail closed.",
      "type": "integer",
      "const": 3
    },
    "id": {
    ...
    "dashboards": {
      "title": "Dashboards",
      "description": "This workspace's Dashboard documents in canonical workspace Dashboard order: [] for none, one entry for the current common case, several once multi-Dashboard selection ships. Dashboard IDs are unique within the workspace; tile, filter, and layout placement IDs stay Dashboard-local. The bound matches the portable-bundle Dashboard capacity rather than introducing a second one. Required even when empty.",
      "type": "array",
      "maxItems": 32,
      "items": {
        "$ref": "dashboard-v1.schema.json"
...
export const schemasById = {
  ...
  "https://altinity.com/schemas/altinity-sql-browser/dashboard-layout-grafana-grid-v2.schema.json": grafanaGridLayoutV2Schema,
